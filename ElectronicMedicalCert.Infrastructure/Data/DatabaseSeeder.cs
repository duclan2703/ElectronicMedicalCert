...
public static class DatabaseSeeder
{
    public static async Task SeedAsync(ElectronicMedicalCertDbContext db, ILogger logger, bool enableTermxFetch = true, CancellationToken ct = default)
    {
        ...
        {
            NewItem(SeedIds.ItStavPlatny, SeedIds.CbStavPosudku, "stav_posudku_platny", "Platný", "Valid"),
            NewItem(SeedIds.ItStavZneplatneny, SeedIds.CbStavPosudku, "stav_posudku_zneplatneny", "Zneplatněný", "Invalidated"),
            NewItem(SeedIds.ItAkceVytvoreni, SeedIds.CbTypAkce, "akce_ro_vytvoreni", "Vytvoření", "Creation"),
            NewItem(SeedIds.ItAkceZneplatneni, SeedIds.CbTypAkce, "akce_ro_zneplatneni", "Zneplatnění", "Invalidation"),
            NewItem(SeedIds.ItDruhProhlidkyVstupni, SeedIds.CbDruhProhlidky, "druh_prohlidky_ro_vstupni", "Vstupní prohlídka", "Initial examination"),
            NewItem(SeedIds.ItDruhProhlidkyPeriodicka, SeedIds.CbDruhProhlidky, "druh_prohlidky_ro_periodicka", "Periodická prohlídka", "Periodic examination"),
            NewItem(SeedIds.ItDruhProhlidkyMimoradna, SeedIds.CbDruhProhlidky, "druh_prohlidky_ro_mimoradna", "Mimořádná prohlídka", "Extraordinary examination"),
            NewItem(SeedIds.ItDruhPosudkuRo, SeedIds.CbDruhPosudku, "druh_posudku_ro", "Řidičské oprávnění", "Driving licence"),
            NewItem(SeedIds.ItVysledekZpusobily, SeedIds.CbVysledek, "vysledek_posudku_ro_zpusobily", "Způsobilý", "Fit"),
            NewItem(SeedIds.ItVysledekNezpusobily, SeedIds.CbVysledek, "vysledek_posudku_ro_nezpusobily", "Nezpůsobilý", "Unfit"),
            NewItem(SeedIds.ItVysledekZpusobilySPodminkou, SeedIds.CbVysledek, "vysledek_posudku_ro_zpusobily_s_podminkou", "Způsobilý s podmínkou", "Fit with condition"),
            NewItem(SeedIds.ItSkupinaZadatelRidic, SeedIds.CbSkupinaZadateleRidic, "skupina_ro_1", "Skupina 1", "Group 1"),
            NewItem(SeedIds.ItSkupinaZadatelRidic2, SeedIds.CbSkupinaZadateleRidic, "skupina_ro_2", "Skupina 2", "Group 2"),
