...
public sealed class ElectronicMedicalCertDbContext(DbContextOptions<ElectronicMedicalCertDbContext> options) : DbContext(options), IElectronicMedicalCertDbContext
{
    ...
    private static void Seed(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CodebookItem>().HasData(
            new CodebookItem { Id = SeedIds.ItStavPlatny, CodebookId = SeedIds.CbStavPosudku, Kod = "PLATNY", Verze = "1" },
            new CodebookItem { Id = SeedIds.ItStavZneplatneny, CodebookId = SeedIds.CbStavPosudku, Kod = "ZNEPLATNENY", Verze = "1" },
            new CodebookItem { Id = SeedIds.ItAkceVytvoreni, CodebookId = SeedIds.CbTypAkce, Kod = "VYTVORENI", Verze = "1" },
            new CodebookItem { Id = SeedIds.ItAkceZneplatneni, CodebookId = SeedIds.CbTypAkce, Kod = "ZNEPLATNENI", Verze = "1" },
            new CodebookItem { Id = SeedIds.ItDruhProhlidkyVstupni, CodebookId = SeedIds.CbDruhProhlidky, Kod = "VSTUPNI", Verze = "1" },
            new CodebookItem { Id = SeedIds.ItDruhPosudkuRo, CodebookId = SeedIds.CbDruhPosudku, Kod = "RO", Verze = "1" },
            new CodebookItem { Id = SeedIds.ItVysledekZpusobily, CodebookId = SeedIds.CbVysledek, Kod = "ZPUSOBILY", Verze = "1" },
            new CodebookItem { Id = SeedIds.ItVysledekNezpusobily, CodebookId = SeedIds.CbVysledek, Kod = "NEZPUSOBILY", Verze = "1" },
            new CodebookItem { Id = SeedIds.ItSkupinaZadatelRidic, CodebookId = SeedIds.CbSkupinaZadateleRidic, Kod = "RIDIC", Verze = "1" },
        ...
        modelBuilder.Entity<CodebookItem>().OwnsMany(x => x.Preklady).HasData(
            ...
            SeedItemTranslation(SeedIds.ItAkceVytvoreni, SeedIds.ItAkceVytvoreniTrEn, "en", "Create", null),
            SeedItemTranslation(SeedIds.ItAkceZneplatneni, SeedIds.ItAkceZneplatneniTrCs, "cs", "Zneplatnění", null),
            SeedItemTranslation(SeedIds.ItAkceZneplatneni, SeedIds.ItAkceZneplatneniTrEn, "en", "Invalidate", null),
            SeedItemTranslation(SeedIds.ItDruhProhlidkyVstupni, SeedIds.ItDruhProhlidkyVstupniTrCs, "cs", "Vstupní", null),
            SeedItemTranslation(SeedIds.ItDruhProhlidkyVstupni, SeedIds.ItDruhProhlidkyVstupniTrEn, "en", "Initial", null),
            ...
            SeedItemTranslation(SeedIds.ItSkupinaZadatelRidic, SeedIds.ItSkupinaZadatelRidicTrCs, "cs", "Řidič", null),
            SeedItemTranslation(SeedIds.ItSkupinaZadatelRidic, SeedIds.ItSkupinaZadatelRidicTrEn, "en", "Driver", null),
